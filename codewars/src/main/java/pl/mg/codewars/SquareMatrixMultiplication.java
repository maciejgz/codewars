...
public class SquareMatrixMultiplication {
     ...
     * in the nth row of matrix A by the elements in the mth column of matrix B, then take the
     * sum of all those products. This will give you the value for cell [m][n] in matrix C.
     * <p>
     * Example
     * A         B          C
     * |1 2|  x  |3 2|  =  | 5 4|
